...
<body>
	<div id="header">
		...
		<nav>
			<ul id="menu">
				...
				<li><a href="cartcontact_oops.php">Contact</a></li>
	...
	<div id="main">
		...
		<?php	foreach($_SESSION['product'] as $j){ ?>
			...
			<h3 class="title">
			<a href="#" id="productName" class="product-name">
			<?php echo $j['productName'] ?></a></h3>
			<span id="price">Price: $</span><span id="price" class="price">
	...
	<table class="addtocartTable" style="height: 50px;border-collapse: collapse;width: 90%;margin-left: 5%;margin-right: 5%;">
	...
	<script>
		...
		$(".add-to-cart").click(function()
		{
			...
			var name=$(this).parent().find(".product-name").text().trim();
